...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Bulan Mei 2022 pada 04.28
...
(2, 'Mudah Belajar Komputer Anak', 1, 'Bambang Agus Setiawan', 'Huta Media', 2014, '9786025118500', 3, 3, 3, 'img1557402397.jpg'),
...
('18042022001', '2022-04-18', '18042022001', 13, '2022-04-21', '2022-04-18', 'Kembali', 0);
...
CREATE TABLE `temp` (
  ...
  `email_user` varchar(123) CHARACTER SET latin1 DEFAULT NULL,
...
(14, 'user', 'Jl.Pemuda 1', 'user@user.com', 'default.jpg', '$2y$10$6pM8R0luKOSebAEaB..8ROBUls0/9zA7aS4RzH7Y6PrZf16Z7usoe', 2, 1, 1652148967);
